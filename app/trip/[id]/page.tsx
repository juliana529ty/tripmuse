...
export default function TripDetailPage() {
  ...
  const toggleFavorite = async () => {
    if (!trip || !user?.id || updatingFavorite) {
      return;
    }

    const previousValue = trip.favorite;
    ...
    <div className="min-h-screen bg-[#fafafa] text-gray-950 print:bg-white">
      ...
      <main className="px-5 py-8 md:px-8 md:py-12 print:px-0 print:py-0">
        <div className="mx-auto max-w-6xl space-y-8">
          ...
          <section className="relative overflow-hidden rounded-[2.25rem] bg-gray-950 p-7 text-white shadow-2xl shadow-gray-300/60 md:p-10 print:rounded-none print:bg-white print:p-0 print:text-gray-950 print:shadow-none">
            <div className="pointer-events-none absolute -right-20 -top-28 h-80 w-80 rounded-full bg-purple-500/30 blur-3xl print:hidden" />
            <div className="pointer-events-none absolute -bottom-32 left-20 h-80 w-80 rounded-full bg-pink-500/20 blur-3xl print:hidden" />
            <div className="pointer-events-none absolute right-1/3 top-1/2 h-52 w-52 rounded-full bg-blue-500/20 blur-3xl print:hidden" />

            <div className="relative">
              <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-3xl">
                  <div className="flex flex-wrap gap-2">
                    <span className="rounded-full border border-white/10 bg-white/10 px-3 py-1.5 text-xs font-semibold text-white/80 backdrop-blur print:border-gray-200 print:bg-gray-100 print:text-gray-600">
                      ✨ AI Travel Plan
                    </span>
                  ...
                  <h1 className="mt-3 break-words text-4xl font-black tracking-[-0.04em] sm:text-5xl md:text-6xl print:text-4xl">
                    {trip.destination}
                  </h1>

                  <p className="mt-5 max-w-2xl text-sm leading-7 text-white/60 md:text-base print:text-gray-500">
                    A personalized itinerary created with
                    TripMuse, designed around your time and
                    budget.
                  </p>
                </div>

                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                  <div className="rounded-2xl border border-white/10 bg-white/10 px-5 py-4 backdrop-blur print:border-gray-200 print:bg-white">
                  ...
                  <div className="col-span-2 rounded-2xl border border-white/10 bg-white/10 px-5 py-4 backdrop-blur sm:col-span-1 print:border-gray-200 print:bg-white">
                    <p className="text-xs text-white/50 print:text-gray-400">
                      Created
                    </p>
              ...
              <div className="mt-9 flex flex-wrap gap-3 print:hidden">
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-gray-950 transition hover:-translate-y-0.5 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {trip.favorite
                    ? "❤️ Favorited"
                    : "🤍 Add to favorites"}
                ...
                <button
                  onClick={shareTrip}
                  disabled={sharing}
                  className="inline-flex items-center justify-center rounded-2xl border border-white/15 bg-white/10 px-5 py-3 text-sm font-semibold text-white backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/15 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {sharing
                    ? "Sharing..."
                    : "🔗 Share trip"}
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_300px] print:block">
            <div className="space-y-6">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-purple-500 print:text-gray-500">
                  Day by day
                </p>
              ...
              {itineraryDays.length === 0 ? (
                ...
                itineraryDays.map((day, dayIndex) => (
                  <section
                    ...
                    className="break-inside-avoid overflow-hidden rounded-[2rem] border border-gray-200 bg-white shadow-sm print:rounded-none print:border-x-0 print:border-b-0 print:shadow-none"
                  >
                    <div className="flex items-center gap-4 border-b border-gray-100 bg-gradient-to-r from-pink-50 via-purple-50 to-blue-50 px-6 py-5 print:bg-white">
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gray-950 text-sm font-bold text-white print:border print:border-gray-300 print:bg-white print:text-gray-950">
                        {dayIndex + 1}
                      </div>
                    ...
                    <div className="p-6 md:p-8 print:px-0">
                      {day.sections.map(
                        (section, sectionIndex) => {
                          ...
                          return (
                            ...
                            >
                              {!isLastSection && (
                                <div className="absolute bottom-0 left-5 top-10 w-px bg-gray-200 print:bg-gray-300" />
                              )}

                              <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-gray-200 bg-white text-xl shadow-sm print:shadow-none">
                                {section.icon}
                              </div>
                ...
                <section className="relative overflow-hidden rounded-[2rem] bg-gray-950 p-6 text-white">
                  ...
                  <div className="relative">
                    ...
                    <p className="mt-3 text-sm leading-7 text-white/60">
                      把这份行程生成登机牌、小票和手账票据风格的可打印旅行收藏。
                    </p>

                    <button
                      onClick={() =>
                        showToast(
                          "Ticket Journal 正在设计中 🎟️"
                        )
                      }
                      className="mt-5 w-full rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-gray-950 transition hover:bg-gray-100"
                    >
                      Preview coming soon
                    </button>
                  </div>
      ...
      {toast && (
        <div className="fixed bottom-6 left-1/2 z-[100] -translate-x-1/2 rounded-2xl bg-gray-950 px-5 py-3 text-sm font-medium text-white shadow-2xl print:hidden">
          {toast}
        </div>
      )}
    </div>
